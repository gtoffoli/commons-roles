...
class BackendTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.role_1 = roles.utils.register_role("Role 1")
        self.user = User.objects.create(username="john")
        self.page_1 = FlatPage.objects.create(url="/page-1/", title="Page 1")
        self.view = roles.utils.register_permission("View", "view")
    ...
    def test_has_perm(self):
        ...
        roles.utils.grant_permission(self.page_1, self.role_1, self.view)
...
class RoleTestCase(TestCase):
    ...
    def setUp(self):
        ...
        """
        self.role_1 = roles.utils.register_role("Role 1")
        self.role_2 = roles.utils.register_role("Role 2")
    ...
    def test_getter(self):
        ...
        """
        # Group
        result = roles.utils.get_group(self.group.id)
        self.assertEqual(result, self.group)

        result = roles.utils.get_group(42)
        self.assertEqual(result, None)

        result = roles.utils.get_group(self.group.name)
        self.assertEqual(result, self.group)

        result = roles.utils.get_group("Not Existing")
        self.assertEqual(result, None)

        # Role
        result = roles.utils.get_role(self.role_1.id)
        self.assertEqual(result, self.role_1)

        result = roles.utils.get_role(42)
        self.assertEqual(result, None)

        result = roles.utils.get_role(self.role_1.name)
        self.assertEqual(result, self.role_1)

        result = roles.utils.get_role("Not Existing")
        self.assertEqual(result, None)

        result = roles.utils.get_user(self.user.id)
        self.assertEqual(result, self.user)

        result = roles.utils.get_user(42)
        self.assertEqual(result, None)

        result = roles.utils.get_user(self.user.username)
        self.assertEqual(result, self.user)

        result = roles.utils.get_user("Not Existing")
        self.assertEqual(result, None)
    ...
    def test_global_roles_user(self):
        ...
        """
        # Add role 1
        result = roles.utils.add_role(self.user, self.role_1)
        self.assertEqual(result, True)
        ...
        result = roles.utils.get_roles(self.user)
        self.assertEqual(list(result), [self.role_1])

        # Add role 2
        result = roles.utils.add_role(self.user, self.role_2)
        self.assertEqual(result, True)
        ...
        # Remove role 1
        result = roles.utils.remove_role(self.user, self.role_1)
        self.assertEqual(result, True)
        ...
        # Remove role 2
        result = roles.utils.remove_role(self.user, self.role_2)
        self.assertEqual(result, True)
    ...
    def test_global_roles_group(self):
        ...
        """
        # Add role 1
        result = roles.utils.add_role(self.group, self.role_1)
        self.assertEqual(result, True)
        ...
        result = roles.utils.get_global_roles(self.group)
        self.assertEqual(result, [self.role_1])

        # Add role 2
        result = roles.utils.add_role(self.group, self.role_2)
        self.assertEqual(result, True)
        ...
        # Remove role 1
        result = roles.utils.remove_role(self.group, self.role_1)
        self.assertEqual(result, True)
        ...
        # Remove role 2
        result = roles.utils.remove_role(self.group, self.role_2)
        self.assertEqual(result, True)
    ...
    def test_remove_roles_user(self):
        ...
        # Remove roles
        result = roles.utils.remove_roles(self.user)
        self.assertEqual(result, True)
    ...
    def test_remove_roles_group(self):
        ...
        # Remove roles
        result = roles.utils.remove_roles(self.group)
        self.assertEqual(result, True)
    ...
    def test_local_role_user(self):
        ...
        result = roles.utils.add_local_role(self.page_1, self.user, self.role_1)
        self.assertEqual(result, True)
        ...
        result = roles.utils.get_local_roles(self.page_1, self.user)
        self.assertEqual(result, [self.role_1])

        # Add local role 2
        result = roles.utils.add_local_role(self.page_1, self.user, self.role_2)
        self.assertEqual(result, True)
        ...
        # Remove role 1
        result = roles.utils.remove_local_role(self.page_1, self.user, self.role_1)
        self.assertEqual(result, True)
        ...
        # Remove role 2
        result = roles.utils.remove_local_role(self.page_1, self.user, self.role_2)
        self.assertEqual(result, True)
    ...
    def test_local_role_group(self):
        ...
        """
        # Add local role to page 1
        result = roles.utils.add_local_role(self.page_1, self.group, self.role_1)
        self.assertEqual(result, True)
        ...
        result = roles.utils.get_local_roles(self.page_1, self.group)
        self.assertEqual(result, [self.role_1])

        # Add local role 2
        result = roles.utils.add_local_role(self.page_1, self.group, self.role_2)
        self.assertEqual(result, True)
        ...
        # Remove role 1
        result = roles.utils.remove_local_role(self.page_1, self.group, self.role_1)
        self.assertEqual(result, True)
        ...
        # Remove role 2
        result = roles.utils.remove_local_role(self.page_1, self.group, self.role_2)
        self.assertEqual(result, True)
    ...
    def test_remove_local_roles_user(self):
        ...
        result = roles.utils.remove_local_roles(self.page_1, self.user)
        self.assertEqual(result, True)
    ...
    def test_get_groups_1(self):
        ...
        result = roles.utils.add_role(self.group_2, self.role_1)
    ...
    def test_get_groups_2(self):
        ...
        self.group_2 = Group.objects.create(name="atheists")
        result = roles.utils.add_local_role(self.page_1, self.group_2, self.role_1)
    ...
    def test_get_users_1(self):
        ...
        result = roles.utils.add_role(self.user_2, self.role_1)
    ...
    def test_get_users_2(self):
        ...
        self.user_2 = User.objects.create(username="jane")
        result = roles.utils.add_local_role(self.page_1, self.user_2, self.role_1)
...
class PermissionTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create(username="john")
        roles.utils.add_role(self.user, self.role_1)
        self.user.save()

        self.page_1 = FlatPage.objects.create(url="/page-1/", title="Page 1")
        self.page_2 = FlatPage.objects.create(url="/page-2/", title="Page 2")

        self.permission = roles.utils.register_permission("View", "view")

    def test_add_permissions(self):
        """
        """
        # Add per object
        result = roles.utils.grant_permission(self.page_1, self.role_1, self.permission)
        self.assertEqual(result, True)

        # Add per codename
        result = roles.utils.grant_permission(self.page_1, self.role_1, "view")
        self.assertEqual(result, True)

        # Add ermission which does not exist
        result = roles.utils.grant_permission(self.page_1, self.role_1, "hurz")
        self.assertEqual(result, False)
    ...
    def test_remove_permission(self):
        ...
        # Remove
        result = roles.utils.remove_permission(self.page_1, self.role_1, "view")
        self.assertEqual(result, True)
    ...
    def test_has_permission_role(self):
        """
        """
        result = roles.utils.has_permission(self.page_1, self.user, "view")
        self.assertEqual(result, False)
    ...
    def test_has_permission_owner(self):
        ...
        result = roles.utils.has_permission(self.page_1, creator, "view")
        self.assertEqual(result, False)

        owner = roles.utils.register_role("Owner")
        roles.utils.grant_permission(self.page_1, owner, "view")

        result = roles.utils.has_permission(self.page_1, creator, "view", [owner])
        self.assertEqual(result, True)
    ...
    def test_local_role(self):
        ...
        roles.utils.grant_permission(self.page_1, self.role_2, self.permission)
        roles.utils.add_local_role(self.page_1, self.user, self.role_2)
    ...
    def test_ineritance(self):
        """
        """
        result = roles.utils.is_inherited(self.page_1, "view")
        self.assertEqual(result, True)

        # per permission
        roles.utils.add_inheritance_block(self.page_1, self.permission)

        result = roles.utils.is_inherited(self.page_1, "view")
        self.assertEqual(result, False)

        roles.utils.remove_inheritance_block(self.page_1, self.permission)

        result = roles.utils.is_inherited(self.page_1, "view")
        self.assertEqual(result, True)

        # per codename
        roles.utils.add_inheritance_block(self.page_1, "view")

        result = roles.utils.is_inherited(self.page_1, "view")
        self.assertEqual(result, False)

        roles.utils.remove_inheritance_block(self.page_1, "view")
    ...
    def test_unicode(self):
        ...
        # ObjectPermission
        roles.utils.grant_permission(self.page_1, self.role_1, self.permission)
...
class RegistrationTestCase(TestCase):
    ...
    def test_group(self):
        ...
        """
        # Register a group
        result = roles.utils.register_group("Brights")
        ...
        result = roles.utils.unregister_group("Brights")
        self.assertEqual(result, True)
    ...
    def test_role(self):
        ...
        """
        # Register a role
        result = roles.utils.register_role("Editor")
        ...
        # Unregister the role
        result = roles.utils.unregister_role("Editor")
        self.assertEqual(result, True)
    ...
    def test_permission(self):
        ...
        result = roles.utils.register_permission("Change", "change")
        ...
        result = roles.utils.register_permission("Change2", "change")
        self.assertEqual(result, False)
        ...
        result = roles.utils.register_permission("Change", "change2")
        self.assertEqual(result, False)
        ...
        result = roles.utils.unregister_permission("change")
        self.assertEqual(result, True)
